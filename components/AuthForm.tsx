...
label='Last Name' placeholder='Enter your first last name' />
</div>
...
label='City' placeholder='Example: San Francisco' />

<div className='flex gap-4'>


<CustomInput control={form.control} name='state'
label='State' placeholder='Example: CA' />
<CustomInput control={form.control} name='postalCode'
label='Postal Code' placeholder='Example: 12345' />
</div>
<div className='flex gap-4'>
